...
import { markShipmentDelivered } from "@/server/services/shipment-service";
...
export async function POST(
  ...
  try {
    ...
    const updated = await markShipmentDelivered(parsedShipmentId, user.id);
    await createAuditLog({
      actorId: user.id,
      actionType: "SUPPLIER_MARK_SHIPMENT_DELIVERED",
      targetType: "SHIPMENT",
