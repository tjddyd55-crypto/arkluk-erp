...
export default function BuyerDashboardPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold text-slate-900">{t("role_buyer_dashboard")}</h1>
          ...
          <table className="min-w-full border-collapse text-sm">
            <thead>
              <tr className="bg-slate-50">
                ...
                <th className="border border-slate-200 px-2 py-1 text-left">{t("order_date")}</th>
                <th className="border border-slate-200 px-2 py-1 text-left">{t("product_count")}</th>
                <th className="border border-slate-200 px-2 py-1 text-left">{t("payment_status")}</th>
