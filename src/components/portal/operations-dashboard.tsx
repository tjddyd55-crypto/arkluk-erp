...
export function OperationsDashboard() {
  ...
  if (!data) {
    return <p className="text-sm text-gray-400">Operations Dashboard 로딩 중...</p>;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <article className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
          <h2 className="text-lg font-semibold text-white">주문 상태 통계</h2>
        ...
        <article className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
          <h2 className="text-lg font-semibold text-white">배송 진행 상황 (Shipment)</h2>
          <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
      ...
      {isSuperAdmin ? (
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
            <h2 className="text-lg font-semibold text-white">국가별 주문 현황</h2>
            <div className="mt-2 overflow-auto">
              <table className="min-w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-[#111318]">
                    <th className="border border-[#2d333d] px-2 py-1 text-left">국가</th>
                    <th className="border border-[#2d333d] px-2 py-1 text-left">주문 수</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  {data.superAdmin.countryOrderStats.length === 0 ? (
                    <tr>
                      <td className="border border-[#2d333d] px-2 py-3 text-center text-gray-400" colSpan={2}>
                        데이터가 없습니다.
                      </td>
                    </tr>
                  ) : null}
          ...
          <article className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
            <h2 className="text-lg font-semibold text-white">공급사별 주문 현황</h2>
            <div className="mt-2 overflow-auto">
              <table className="min-w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-[#111318]">
      ...
      {isKoreaSupplyAdmin ? (
        <section className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
          <h2 className="text-lg font-semibold text-white">공급사 주문 현황 (상태별)</h2>
          <div className="mt-2 overflow-auto">
            <table className="min-w-full border-collapse text-sm">
              <thead>
                <tr className="bg-[#111318]">
                  <th className="border border-[#2d333d] px-2 py-1 text-left">공급사</th>
                  <th className="border border-[#2d333d] px-2 py-1 text-left">상태별 수량</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
        <h2 className="text-lg font-semibold text-white">Delayed Orders</h2>
        <div className="mt-2 overflow-auto">
          <table className="min-w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#111318]">
                ...
                <th className="border border-[#2d333d] px-2 py-1 text-left">지연 공급사</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">배정 시각</th>
              </tr>
            </thead>
            <tbody>
              {data.delayedOrders.map((row) => (
                <tr key={row.id}>
                  <td className="border border-[#2d333d] px-2 py-1">
                    <Link href={`/admin/orders/${row.id}`} className="text-blue-400 underline">
                      {row.orderNo}
                    </Link>
                  </td>
                  <td className="border border-[#2d333d] px-2 py-1">
      ...
      <section className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
        <h2 className="text-lg font-semibold text-white">Delayed Shipments</h2>
        <div className="mt-2 overflow-auto">
          <table className="min-w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#111318]">
                <th className="border border-[#2d333d] px-2 py-1 text-left">Shipment</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">주문번호</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">공급사</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">출고 시각</th>
              </tr>
            </thead>
            <tbody>
              {data.delayedShipments.map((row) => (
                <tr key={row.id}>
                  <td className="border border-[#2d333d] px-2 py-1">{row.shipmentNo}</td>
                  <td className="border border-[#2d333d] px-2 py-1">
                    <Link href={`/admin/orders/${row.orderId}`} className="text-blue-400 underline">
                      {row.orderNo}
                    </Link>
                  </td>
                  <td className="border border-[#2d333d] px-2 py-1">{row.supplierName}</td>
      ...
      <section className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
        <h2 className="text-lg font-semibold text-white">최근 주문 10개</h2>
        <div className="mt-2 overflow-auto">
          <table className="min-w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#111318]">
                ...
                <th className="border border-[#2d333d] px-2 py-1 text-left">국가</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">바이어</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">주문 상태</th>
      ...
      <section className="rounded border border-[#2d333d] bg-[#1a1d23] p-4">
        <h2 className="text-lg font-semibold text-white">최근 배송 상태</h2>
        <div className="mt-2 overflow-auto">
          <table className="min-w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#111318]">
                <th className="border border-[#2d333d] px-2 py-1 text-left">시간</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">공급사</th>
                <th className="border border-[#2d333d] px-2 py-1 text-left">메시지</th>
              </tr>
            </thead>
            <tbody>
